...
#### Grace Notes: This will be simplier for us since we just input straight temp. 
#### Grace Notes: But we will be inputting temp for two sites, headwater and reservoir.
#### Grace Notes: Thankfully they don't need to be regarded at once
#### Grace Notes: Once we hit threshold we switch which temp values used
...
#### Grace Notes: This is point of insertion for our development model
#### Grace Notes: We include necessary formulas and run as temp. dependent
...
#### Grace Notes: Above is similiar to what we'll need for salmon egg breakpoint
#### Grace Notes: This has the domain in phys age, we adjust for size
...
#### Grace Notes: Below are parameters for development rate of different stages
#### Grace Notes: For our model, we assume certain amount of growth on temp.
...
#### Grace Notes: This sets up the carry-over in the integral.
#### Grace Notes: avec being the domain for physiological age

  ##########################################

  # Initializing the old eggs
  OldE = rep(0,length(avec)) #replicating the number of old_eggs #avec_length times
...
#### Grace Notes: Oviposition involves variable number of eggs based on temp.
#### Grace Notes: We can remove this for our purposes, initally assuming no mortality
#### Grace Notes: In future revisions, this could apply to the model to simulate
#### Grace Notes: the number of actual fish emerged.
#### Grace Notes: Depending on performance, including mortality may be required.

#### Grace Notes: The next section computes development rate for different stages 
#### Grace Notes: and has the the carry-over between stages 
#### Grace Notes: where the beetles/fish that are past the breakpoint/threshold
#### Grace Notes: go into the next stage (e.g. eggs to larvae, etc.)
...
#### Grace Notes: Below is a test of the IMAP function, as written above.
#### Grace Notes: There are additional commands to print a graph / plot of the data
#### Grace Notes: which is the number of individuals in a given life stage over time
#### Grace Notes: with each life stage represented as its own line.
